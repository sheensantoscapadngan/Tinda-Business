...
public class ShopFeedAdapter extends RecyclerView.Adapter<ShopFeedAdapter.ViewHolder>{
    ...
    private void deleteFeedPost(int position) {

        DatabaseReference postRef = rootRef.child("Posts").child(businessID).child(postIdList.get(position));
        postRef.setValue(null);

        postTimeList.remove(position);
        postHeaderList.remove(position);
        postImageList.remove(position);
        postDescriptionList.remove(position);
        postLikesList.remove(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private ImageView image,like,comment,trash;
        ...
        public ViewHolder(View itemView) {
            ...
            trash = (ImageView) itemView.findViewById(R.id.imageViewShopFeedTrash);
